...
public class Conexion {
    public static Connection getConnection() throws BDException { //el throws es para traer varios errores a la vez
        Connection con= null;
        try{ 
            con= DriverManager.getConnection("jdbc:mysql://localhost:3306/inasistencias?zeroDateTimeBehavior=CONVERT_TO_NULL", "root", ""); //root es nombre de usuario y lo otro la contraseña
